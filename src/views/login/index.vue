<template>
  <div class="login-wrapper">
    ...
    <div class="login-left">
      <img src="../../assets/Qingming2021_ZH-CN6154314555_1920x1080.jpg" alt="">
    </div>
        ...
        <div class="login-form">
          ...
          <div class="form-item-code">
            <div class="form-item code-item">
              <i class="el-icon-house"></i>
              <input type="text" placeholder="请输入密码" v-model="loginForm.captcha">
            </div>
...
.login-wrapper {
  ...
  .login-form-wrapper {
    ...
    .form-logo {
      width: 150px;
      height: 35px;
      background-image: url('../../assets/wen.png');
    }
