<template>
    <div class="brand-wrapper">
        ...
        <!--    操作功能 -->
        <div class="crud-box">
            <el-button type="primary" v-has-prem="['good:add']" size="mini" icon="el-icon-edit" @click="dialogVisible=true,formData={},imageUrl=''">新建</el-button>
            <el-button type="success" v-has-prem="['good:edit']" size="mini" icon="el-icon-edit" :disabled="batchIds.length!=1" @click="dialogVisible=true,findById()">修改</el-button>
            <el-button type="danger" v-has-prem="['good:batch']" size="mini" icon="el-icon-delete" :disabled="batchIds.length<=0"
        ...
        <div class="data-box">
            <el-table
                ...
                <el-table-column
                        ...
                        label="操作">
                    <template v-slot="obj">
                        <el-button type="primary" v-has-prem="['good:edit']" size="mini" icon="el-icon-edit" @click="dialogVisible=true,formData.id=obj.row.id,findById()" style="margin-right:5px ">
                        </el-button>
                        <el-popconfirm
                            v-has-prem="['good:delete']"
