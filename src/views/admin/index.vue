    ...
    <div class="brand-wrapper">
        ...
        <el-dialog
            ...
            <el-form ref="form" label-width="80px" size="small" :model="formData" :rules="rules">
                ...
                <el-row :gutter="10">
                    <el-form-item label="员工地址" style="margin: 0px 5px">
                        <el-select v-model="province" placeholder="请选择省" style="width: 32%" @change="getAllCity">
                            <el-option
                        ...
                        <el-select v-model="city" placeholder="请选择市" style="width: 33% ;margin: 0px 3px" @change="getAllArea" >
                            <el-option
                        ...
                        <el-select v-model="area" placeholder="请选择区/县" style="width: 33% ;margin: 0px 2px" >
                            <el-option
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="16">
                            <img :src="formData.adminAvatar" v-if="formData.adminAvatar" alt="" style=" width: 50px" height="50px">
                    </el-col>
                </el-row>
