    ...
    <div class="brand-wrapper">
        ...
        <div class="crud-box">
            <el-button type="primary" size="mini" icon="el-icon-edit"
                       @click="dialogVisible=true, resetFromData()">新建
            </el-button>
            <el-button type="success" size="mini" icon="el-icon-edit" @click="dialogVisible=true,findById()">修改
            </el-button>
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="菜单排序">
                            <el-input v-model="formData.menuSort"></el-input>
                        </el-form-item>
                    </el-col>
