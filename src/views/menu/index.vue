<template>
  <div class="brand-wrapper">
    ...
    <!--    操作功能 -->
    <div class="crud-box">
      <el-button type="primary" v-has-prem="['menu:add']" size="mini" icon="el-icon-edit"
                 @click="dialogVisible=true, resetFromData(),getAllMenuTree()">新建
      </el-button>
    ...
    <div class="data-box">
      <el-table
        ...
        <el-table-column
            ...
            width="180">
          <template v-slot="obj">
            <el-tag v-if="obj.row.menuType==0" type="success">目录</el-tag>
            <el-tag v-if="obj.row.menuType==1" type="primary">菜单</el-tag>
        ...
        <el-table-column
            ...
            label="操作">
          <template v-slot="obj">
            <el-button type="primary" v-has-prem="['menu:edit']" size="mini" icon="el-icon-edit"
                       @click="dialogVisible=true,formData.id=obj.row.id,findById()"
                       style="margin-right:5px ">
            </el-button>
            <el-popconfirm
                v-has-prem="['menu:delete']"
        ...
        <el-row :gutter="20" v-if="formData.menuType!=2">
          <el-col :span="24">
            <el-form-item label="菜单图标">
              <icon-picker v-model="formData.menuIcon"></icon-picker>
